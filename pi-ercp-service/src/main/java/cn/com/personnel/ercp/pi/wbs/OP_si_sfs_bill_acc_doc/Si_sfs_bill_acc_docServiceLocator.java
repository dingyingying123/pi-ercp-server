/**
 * Si_sfs_bill_acc_docServiceLocator.java
 *
...
public class Si_sfs_bill_acc_docServiceLocator extends org.apache.axis.client.Service implements Si_sfs_bill_acc_docService {

    public Si_sfs_bill_acc_docServiceLocator() {
    }


    public Si_sfs_bill_acc_docServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public Si_sfs_bill_acc_docServiceLocator(String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for HTTPS_Port
    private String HTTPS_Port_address = "https://pev.goldwind.com.cn:50001/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_SFS&receiverParty=&receiverService=&interface=si_sfs_bill_acc_doc&interfaceNamespace=urn%3Agoldwind.com%3Ai_sfs%3Asfs_bill_acc_doc";
    ...
    public Si_sfs_bill_acc_doc getHTTPS_Port(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            Si_sfs_bill_acc_docBindingStub _stub = new Si_sfs_bill_acc_docBindingStub(portAddress, this);
    ...
    private String HTTP_Port_address = "http://pev.goldwind.com.cn:50000/XISOAPAdapter/MessageServlet?senderParty=&senderService=BS_SFS&receiverParty=&receiverService=&interface=si_sfs_bill_acc_doc&interfaceNamespace=urn%3Agoldwind.com%3Ai_sfs%3Asfs_bill_acc_doc";
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (Si_sfs_bill_acc_doc.class.isAssignableFrom(serviceEndpointInterface)) {
                Si_sfs_bill_acc_docBindingStub _stub = new Si_sfs_bill_acc_docBindingStub(new java.net.URL(HTTPS_Port_address), this);
                _stub.setPortName(getHTTPS_PortWSDDServiceName());
                return _stub;
            }
            if (Si_sfs_bill_acc_doc.class.isAssignableFrom(serviceEndpointInterface)) {
                Si_sfs_bill_acc_docBindingStub _stub = new Si_sfs_bill_acc_docBindingStub(new java.net.URL(HTTP_Port_address), this);
                _stub.setPortName(getHTTP_PortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:goldwind.com:i_sfs:sfs_bill_acc_doc", "si_sfs_bill_acc_docService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:goldwind.com:i_sfs:sfs_bill_acc_doc", "HTTPS_Port"));
            ports.add(new javax.xml.namespace.QName("urn:goldwind.com:i_sfs:sfs_bill_acc_doc", "HTTP_Port"));
        }
