...
//        }
  ...
  //救助金额
    ...
    //救助人数
        $("#zcxjtjzrs").val(homeInfo.succour_spending_prenum);
        $("#jnxjtjzrs").val(homeInfo.succour_difficult_prenum);
  //在享低保家庭提高救助水平
  ...
  //各类合计
    ...
    document.getElementById("memberTRLength").rowSpan=parseInt(memberListInfo.length)+parseInt(1);
    ...
    var marriageNames =["","未婚","已婚","离异","丧偶"];
        for(var  i = 0;i<memberListInfo.length;i++){
        	...
        	var str = '<tr><form id="memberF'+i+'"> '+
    	   	'<td colspan="2"  class="w160" ><input type="text" class="w160  fs20lh30tac" name="member_name" readonly="readonly" value = "'+memberListInfo[i].member_name+'" /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac" readonly="readonly" value = "'+relationships[memberListInfo[i].relationship]+'"  /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac"   readonly="readonly" name="marriage" value = "'+marriage+'" /></td>'+
    	   	'<td colspan="2"  class="w160" ><input type="text" class="w160  fs16lh30tac" name="idcard" readonly="readonly"  value = "'+memberListInfo[i].idcard+'" /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac" name="age" readonly="readonly" value = "'+getAge(memberListInfo[i].idcard)+'" /></td>'+
    	   	'<td colspan="4"  class="w320" ><input type="text" class="w320  fs20lh30tac" readonly="readonly" name="seriously" value = "'+memberListInfo[i].rylbName+'" /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac" name="coefficient" readonly="readonly" value = "'+memberListInfo[i].coefficient+'" /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac"  name="occupation" readonly="readonly" value = "'+memberListInfo[i].occupationName+'" /></td>'+
    	   	'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac" name="income"readonly="readonly" value = "'+memberListInfo[i].income+'" / ></td>'+
    	   	'</form></tr>'
    ...
    for(var j = 0;j<supportListInfo.length;j++){
		...
		'<td colspan="1"  class="w80" ><input type="text" class="w80  fs20lh30tac" name="supportMoney" readonly="readonly"  value = "'+supportListInfo[j].supportmoney+'"  /></td>'+
		'</tr>'
		$("#trValue").append(str);   
    }
