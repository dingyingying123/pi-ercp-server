...
<script type="text/javascript" language="javascript" src="/js/date.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/RemoteService.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/paginate.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/jquery.datatable.extends.js?v=${.now?long}"></script>
...
<script type="text/javascript" language="javascript" src="/js/jquery.jqGrid.editer.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/jquery.jqGrid.column.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/jquery.jqGrid.extends.js?v=${.now?long}"></script>
...
<script type="text/javascript" language="javascript" src="/js/jquery.cxselect.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/js/validate-methods.js?v=${.now?long}"></script>
<script type="text/javascript" language="javascript" src="/plugins/webuploader/webuploader.js"></script>
<script type="text/javascript" language="javascript" src="/js/webuploader.extends.js?v=${.now?long}"></script>
