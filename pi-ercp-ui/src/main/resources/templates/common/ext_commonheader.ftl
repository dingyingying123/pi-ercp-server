...
<div class="header">
    <div class="width-limit clearfix">
        <div class="logo fl-l">
            <a href="/home">
                <img src="/images/logo-w.svg" alt="logo" onclick="goHome()">
            </a>
        </div>
        <div class="nav fl-l">
            <ul id="nav-lis" class="clearfix">
                <li><a href="/home"><@spring.message "commontheader.navigation.homepage"/></a></li>
        ...
        <div class="search-box fl-r pos-r clearfix">
    		<div class="search-input-box pos-r" >
   			...
   			<button type="button" class="search-icons">
