...
@Table(name = "fss_loan_contract_draw_money_plan")
public class FssLoanContractDrawMoneyPlan {
    /**
     * 主键id
     */
    @Id
    ...
    private BigDecimal plannedWithdrawalAmount;
     ...
     */
    public BigDecimal getPlannedWithdrawalAmount() {
     ...
     */
    public void setPlannedWithdrawalAmount(BigDecimal plannedWithdrawalAmount) {
