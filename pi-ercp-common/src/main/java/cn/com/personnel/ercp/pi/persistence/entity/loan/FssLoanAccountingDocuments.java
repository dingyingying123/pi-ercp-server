...
@Table(name = "fss_loan_accounting_documents")
public class FssLoanAccountingDocuments {
    /**
     * 会计分录ID
     */
    @Id
     ...
     * 获取对方利润中心
     *
     * @return opposite_profit_center_code - 对方利润中心
     */
     ...
     * 设置对方利润中心
     *
     * @param oppositeProfitCenterCode 对方利润中心
     */
     ...
     * 获取对方利润中心
     *
     * @return opposite_profit_center - 对方利润中心
     */
     ...
     * 设置对方利润中心
     *
     * @param oppositeProfitCenter 对方利润中心
     */
     ...
     * 获取sap冲销凭证编号
     *
     * @return reversal_sap_no - sap冲销凭证编号
     */
     ...
     * 获取冲销失败消息
     *
     * @return reversal_error_message - 冲销失败消息
     */
     ...
     * 设置冲销失败消息
     *
     * @param reversalErrorMessage 冲销失败消息
     */
     ...
     * 获取贸易伙伴ID
     *
     * @return business_partner_id - 贸易伙伴ID
     */
     ...
     * 设置贸易伙伴ID
     *
     * @param businessPartnerId 贸易伙伴ID
     */
