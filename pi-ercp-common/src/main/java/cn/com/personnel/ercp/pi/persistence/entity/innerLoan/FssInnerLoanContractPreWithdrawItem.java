...
@Table(name = "fss_inner_loan_contract_pre_withdraw_item")
public class FssInnerLoanContractPreWithdrawItem {
    /**
     * 主键id
     */
    @Id
     ...
     * 本次预提(元)
     */
    @Column(name = "this_pre_withdraw_amount")
    private BigDecimal thisPreWithdrawAmount;
     ...
     * 获取本次预提(元)
     *
     * @return this_pre_withdraw_amount - 本次预提(元)
     */
    public BigDecimal getThisPreWithdrawAmount() {
        return thisPreWithdrawAmount;
    }

    /**
     * 设置本次预提(元)
     *
     * @param thisPreWithdrawAmount 本次预提(元)
     */
    public void setThisPreWithdrawAmount(BigDecimal thisPreWithdrawAmount) {
        this.thisPreWithdrawAmount = thisPreWithdrawAmount;
    }
