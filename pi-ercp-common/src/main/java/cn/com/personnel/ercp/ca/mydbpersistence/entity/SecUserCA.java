...
public class SecUserCA {
     ...
     * 获取密码尝试次数
     *
     * @return pwd_times - 密码尝试次数
     */
    public Short getPwdTimes() {
        return pwdTimes;
    }
     ...
     * 设置密码尝试次数
     *
     * @param pwdTimes 密码尝试次数
     */
    public void setPwdTimes(Short pwdTimes) {
