...
public class ServerInterviewInterventionVO extends ServerInterviewInterventionInfo {
    private String flag;
    ...
    public String toString() {
        return "ServerInterviewInterventionVO{" +
                "flag='" + flag + '\'' +
                ", allSubmit='" + allSubmit + '\'' +
                ", area='" + area + '\'' +
                ", childIdNo='" + childIdNo + '\'' +
    ...
    public void setAllSubmit(String allSubmit) {
