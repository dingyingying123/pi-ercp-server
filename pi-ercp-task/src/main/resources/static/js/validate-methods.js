...
$(function() {
    ...
    jQuery.validator.addMethod("isEmail", function(value, element) {
        return this.optional(element) || /^[a-z0-9_-]+@[a-z0-9_-]+(\.[a-z0-9_-]+)+$/.test(value);
    }, "邮箱格式不正确");
    ...
    //注册密码验证
    jQuery.validator.addMethod("isRegPwd", function(value, element) {
    ...
    jQuery.validator.addMethod("isUscCode", function(value, element) {
        return this.optional(element) || /^[A-Z0-9]{18}$/.test(value);
    }, "格式为18位大写字母，数字或组合");
    //组织机构代码证号验证
    jQuery.validator.addMethod("isOrgCode", function(value, element) {
        return this.optional(element) || /^[A-Z0-9]{9}$/.test(value);
    }, "格式为9位大写字母，数字或组合");
    //确认密码对比验证
    jQuery.validator.addMethod("isEqualTo", function(value, element, param) {
        return this.optional(element) || equal(value, param);
    }, "两次输入密码不一致");
    //注册资金（数字、点、逗号）
    jQuery.validator.addMethod("isCapital", function(value, element) {
        return this.optional(element) || /^([1-9][0-9]{0,2}(,[0-9]{3})*)|([1-9][0-9]{0,2}(,[0-9]{3})*|0)\.[0-9]/.test(value);
    }, "货币格式不正确");
    //AD密码校验(大、小写字母、数字、特殊字符)
    jQuery.validator.addMethod("isADPwd", function(value, element) {
